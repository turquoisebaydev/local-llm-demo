...
Each GPU runs the largest Qwen3.5 it can fit: 122B-A10B Q4_K_M on the RTX PRO 6000 Max-Q (96GB), 27B Q5_K_M on the 5090, 27B Q4_K_M on the 4090/3090. Same SVG task, comparing how model size affects output quality and throughput.
